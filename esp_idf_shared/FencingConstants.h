#ifndef FENCINGCONSTANTS_HPP
#define FENCINGCONSTANTS_HPP

// How long the leds turn on when a player hit (ms)
#define FENCING_BLINKING_TIME 2000 * 1000 // 2 secs

// How long between two hits for it to be a double hit (ms)
#define FENCING_LAPS_DOUBLE_TOUCH 250 * 1000 // 0.25 secs

#define FENCING_LAPS_GROUND_NO_TOUCH 200 // FIXME : find the perfect value
